...
var combination = [
    ...
    // создать заявку
    { id: 'вам не', options:['обходимо создать заявку из панели управления хостингом, вот подсказка http://joxi.ru/1A5xRp8Fqpaz2E.jpg'] },  
    { id: 'Вам не', options:['обходимо создать заявку из панели управления хостингом, вот подсказка http://joxi.ru/1A5xRp8Fqpaz2E.jpg'] },  
    ...
    { id: 'Пожалуйста, обращайтесь, всегда рад помочь', options:[". Хорошего дня Вам."] },
    { id: 'Пожалуйста, обращайтесь', options:[", всегда рад помочь"] },
    { id: 'Пожа', options:['луйста, ожидайте', "луйста, обращайтесь", "луйста, ознакомьтесь с инструкцией по ссылке: ", "луйста, создайте заявку из панели управления хостингом, вот подсказка http://joxi.ru/1A5xRp8Fqpaz2E.jpg"] },
