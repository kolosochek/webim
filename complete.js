...
var combination = [
    ...
    { id: 'Пожалуйста, обращайтесь, всегда рад помочь', options:[". Хорошего дня Вам."] },
    { id: 'Пожалуйста, обращайтесь', options:[", всегда рад помочь"] },
    { id: 'Пожа', options:['луйста, ожидайте', "луйста, обращайтесь", "луйста, создайте заявку из панели управления хостингом, вот подсказка http://joxi.ru/1A5xRp8Fqpaz2E.jpg", "луйста, ознакомьтесь с инструкцией по ссылке: "] },
